...
class PortfolioNetwork2410(Topo):
    ...
    def build(self, **_opts):
        ...
        r1 = self.addNode("r1", cls=LinuxRouter,
                          ip='10.0.0.1/24', defaultRoute='via 10.0.1.2')
        for h in (h1, h2, h3):
            self.addLink(h, s1)
        # ,max_queue_size=834, use_htb=True)
        ...
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r1, r2, intfName1='r1-eth1', params1={
                     'ip': '10.0.1.1/24'}, bw=40, delay='10ms', max_queue_size=67, use_htb=True)

        # subnet C  r2 - h7
        h7 = self.addHost("h7", ip="10.0.2.2/24", defaultRoute='via 10.0.2.1')
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r2, h7, intfName1='r2-eth1',
                     params1={'ip': '10.0.2.1/24'})

        # subnet D  r2 - r3
        r3 = self.addNode("r3", cls=LinuxRouter, ip='10.0.3.2/24')
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r2, r3, intfName1='r2-eth2', params1={
                     'ip': '10.0.3.1/24'}, bw=30, delay='20ms', max_queue_size=100, use_htb=True)

        # subnet    r3  - H8
        h8 = self.addHost("h8", ip="10.0.4.2/24", defaultRoute='via 10.0.4.1')
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r3, h8, intfName1='r3-eth1',
        ...
        for h in (h4, h5, h6):
            self.addLink(h, s2)
        # ,max_queue_size=834, use_htb=True)
        self.addLink(s2, r3, intfName2='r3-eth2',
                     params2={'ip': '10.0.5.1/24'})

        # subnet G r3 - r4

        r4 = self.addNode("r4", cls=LinuxRouter,
                          ip='10.0.6.2/24', defaultRoute='via 10.0.6.1')
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r3, r4, intfName1='r3-eth3', params1={
                     'ip': '10.0.6.1/24'}, bw=20, delay='10ms', max_queue_size=33, use_htb=True)

        # subnet I: r4 - H9
        h9 = self.addHost("h9", ip="10.0.7.2/24", defaultRoute='via 10.0.7.1')
        # ,max_queue_size=834, use_htb=True)
        self.addLink(r4, h9, intfName1='r4-eth1',
